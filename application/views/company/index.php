        ...
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <a href="<?=base_url('company/add');?>" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Tambah Data</span></a>
                </div>
            </div>
        </div>
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $comp['name']; ?></td>
                    <td>
                        <a href="<?= base_url(); ?>company/edit/<?= $comp['idcompany']; ?>"><i class="fas fa-edit"></i></a>
                        <a href="<?= base_url(); ?>company/delete/<?= $comp['idcompany']; ?>"><i class="fas fa-trash-alt"></i></a>
                    </td>
                    <?php $i++; ?>
                    <?php endforeach; ?>
                </tr>
